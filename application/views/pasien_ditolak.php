...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Pasien Ditolak</li>
    </ol>
        ...
        <div class="card-body">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="width:17%;">
                <a href="<?php echo base_url('user_adm/profil_pasien_ditolak/'); echo $p->id;?>" class="btn btn-sm btn-primary">Selengkapnya</i></a>
