  ...
  <div class="container-fluid">
    ...
    <div class="card mb-3">
      <div class="card-header">
        <i class="fa fa-pencil"></i> Ubah Kamar RSPA</div>
        <div class="card-body">
          <?php foreach ($kamar as $k) { ?>
          <form class="form-horizontal" id="form-ubah-kamar" action="<?php echo base_url('user_adm/simpan_ubah_kamar')?>" method="post" enctype="multipart/form-data" role="form">
          <input type="hidden" name="id_kamar" value="<?php echo $k->id_kamar; ?>">
            <div class="form-group row">
              <div class="col-md-8">
                <label for="nama_pasien">Nama Kamar</label>
                <input class="form-control" name="nama_kamar" type="text" value="<?php echo $k->nama_kamar; ?>">
              </div>
            </div>
            <div class="form-group row">
              <div class="col-md-5">
                <label for="nama_ortu">Kuota Kamar</label>
                <input class="form-control" name="kuota" type="text" value="<?php echo $k->kuota_kamar; ?>">
              </div>
            </div>
            
            <input class="btn btn-success simpan_ubah_kamar" type="submit" value="Simpan">
