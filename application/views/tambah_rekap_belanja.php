  ...
  <div class="container-fluid">
   ...
   <div class="card mb-3">
    <div class="card-header">
      <i class="fa fa-pencil"></i> Tambah Rekap Belanja</div>
      <div class="card-body">
        <form class="form-horizontal" id="form-tambah-rekap-belanja" action="<?php echo base_url('user_adm/simpan_rekap_belanja')?>" method="post" enctype="multipart/form-data" role="form">
          <div class="form-group row">
            <div class="col-md-8">
              <label for="nama_pasien">Nama Barang</label>
              <input class="form-control" name="nama_barang" type="text" placeholder="Masukkan Nama Barang Di Sini . . .">
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-10">
          ...
          <div class="form-group row">
            <div class="col-md-5">
              ...
              <input class="form-control" name="harga" type="number" placeholder="Masukkan Harga Barang Di Sini . . .">
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5">
              <label for="nama_ortu">Jumlah Barang</label>
              <input class="form-control" name="jml_barang" type="number" placeholder="Masukkan Jumlah Barang Di Sini . . .">
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-4">
              <label for="tanggal_lahir">Tanggal Belanja</label>
              <input id="datepicker" name="tgl_belanja">
            </div>
          </div>
          <input class="btn btn-success simpan_rekap_belanja" type="submit" value="Simpan">
          <input class="btn btn-danger" type="reset" value="Reset">
          <a href="<?php echo base_url('user_adm/rekap_belanja'); ?>" class="btn btn-primary">Kembali</a><br>
        </form>
      </div>
    </div>
  </div>
