  ...
  <div class="container-fluid">
    ...
    <div class="card mb-3">
      <div class="card-header">
        <i class="fa fa-pencil"></i> Tambah Kamar</div>
        <div class="card-body">
          <form class="form-horizontal" id="form-tambah-kamar" action="<?php echo base_url('user_adm/simpan_data_kamar')?>" method="post" enctype="multipart/form-data" role="form">
            <div class="form-group row">
              <div class="col-md-8">
                <label for="nama_pasien">Nama Kamar</label>
                <input class="form-control" name="nama_kamar" type="text" placeholder="Masukkan Nama Kamar Di Sini . . .">
              </div>
            </div>
            <div class="form-group row">
              <div class="col-md-5">
                <label for="nama_ortu">Kuota Kamar</label>
                <input class="form-control" name="kuota" type="text" placeholder="Masukkan Kuota Kamar Di Sini . . .">
              </div>
            </div>
            <input class="btn btn-success simpan_data_kamar" type="submit" value="Simpan">
            <input class="btn btn-danger" type="reset" value="Reset">
            <a href="<?php echo base_url('user_adm/kamar'); ?>" class="btn btn-primary">Kembali</a><br>
          </form>
        </div>
      </div>
    </div>
