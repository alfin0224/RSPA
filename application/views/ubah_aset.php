  ...
  <div class="container-fluid">
   ...
   <div class="card mb-3">
    <div class="card-header">
      <i class="fa fa-pencil"></i> Ubah Aset</div>
      <div class="card-body">
       <?php foreach ($aset as $a) { ?>
       <form class="form-horizontal" id="form-ubah-aset" action="<?php echo base_url('user_adm/simpan_ubah_data_aset')?>" method="post" enctype="multipart/form-data" role="form">
       <input type="hidden" name="id_aset" value="<?php echo $a->id_aset; ?>">
         <div class="form-group row">
          <div class="col-md-8">
            <label for="nama_pasien">Nama Aset</label>
            <input class="form-control" name="nama_aset" type="text" value="<?php echo $a->nama_aset; ?>" required>
          </div>
        </div>
        <div class="form-group row">
          <div class="col-md-5">
            <label for="nama_ortu">Jumlah Aset</label>
            <input class="form-control" name="jml_aset" type="text" value="<?php echo $a->jumlah; ?>" required>
          </div>
        </div>
        <input class="btn btn-success simpan_ubah_aset" type="submit" value="Simpan">
